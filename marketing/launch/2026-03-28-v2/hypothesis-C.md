# Hypothesis C: The Billing Refugee

## The bet
**ICP:** Solo founder currently paying for Jasper or Copy.ai, frustrated with generic output, suspicious of the billing practices, and looking for an exit. They already believe in AI for marketing — they just hate the tool they're using.

**Primary pain:** "Charged $936 for service I never used." "I cancelled my paid plan months ago and they have continued to charge me every month." The pain isn't AI marketing — it's that every AI marketing tool is a subscription trap with cookie-cutter output.
...
**What would prove this wrong:** Target audience is too non-technical to install via git clone — conversion drops at the install step despite interest in the positioning.
...
- Post in "Jasper alternatives" Reddit threads and G2 competitor comparison pages
- Target "alternatives to Jasper" / "Jasper vs" search traffic with a GitHub README section
- Comment on Trustpilot/G2 review threads (carefully — don't spam)
- Signal that confirms: installs from people mentioning Jasper/Copy.ai in GitHub issues or discussions
- Signal that denies: positioning resonates in discussion but installers are actually technical founders who never used Jasper — different ICP than expected
